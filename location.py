...
class Location():
    ...
    def openlocationwindow(self):           # Method displays the location window and its content from selection
        ...
        # Creating right frame and placing on right side of new location window
        ...
        def select(e):              # Method called after listbox selcted value is released
            ...
            # Gets the selected listbox location value
            listbox_value= self.listbox.get(ANCHOR)

            # Gets the selected button value from location frame
        ...
        self.list = sorted(getLocations())          # Gets all unique location and sorts
